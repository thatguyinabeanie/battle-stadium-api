...
ActiveRecord::Schema[7.2].define(version: 2024_12_09_035641) do
  ...
  create_table "pokemon", id: :serial, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "nickname"
    t.integer "pokemon_team_id", default: 0, null: false
    t.string "form"
  ...
  create_table "rk9_tournaments", id: :serial, force: :cascade do |t|
