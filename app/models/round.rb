...
class Round < ApplicationRecord
  ...
  has_many :matches, class_name: "Match", dependent: :destroy, inverse_of: :round
  ...
  def self.create_initial_round(phase)
  ...
  def self.create_matches(round:, players:)
