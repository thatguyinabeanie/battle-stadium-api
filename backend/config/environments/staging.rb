...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "battle_stadium_production"
  ...
  config.hosts = [
    ...
    /battle-stadium-api(-\w+)?\.onrender\.com/ # Allow requests from battle-stadium-api.onrender.com and battle-stadium-api-STUFF.onrender.com
  ]
