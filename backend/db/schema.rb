...
ActiveRecord::Schema[7.1].define(version: 20_240_903_133_719) do
  # These are extensions that must be enabled in order to support this database
  enable_extension 'pgcrypto'
  enable_extension 'plpgsql'
  enable_extension 'uuid-ossp'

  create_table 'accounts', primary_key: %w[provider provider_account_id], force: :cascade do |t|
    ...
    t.index %w[provider provider_account_id], name: 'index_accounts_on_provider_and_provider_account_id', unique: true
  end
  ...
  create_table 'formats', force: :cascade do |t|
    ...
    t.index %w[name game_id], name: 'index_formats_on_name_and_game_id', unique: true
  end
  ...
  create_table 'matches', force: :cascade do |t|
    ...
    t.index %w[round_id player_one_id player_two_id], name: 'index_matches_on_round_and_players_unique', unique: true
  ...
  create_table 'phase_players', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[phase_type phase_id], name: 'index_tournament_phase_players_on_phase'
  ...
  create_table 'players', force: :cascade do |t|
    ...
    t.index %w[user_id tournament_id], name: 'index_players_on_user_id_and_tournament_id', unique: true
  end
  ...
  create_table 'rounds', force: :cascade do |t|
    ...
    t.datetime 'started_at'
    t.datetime 'ended_at'
    t.index %w[phase_id round_number], name: 'index_rounds_on_phase_id_and_round_number', unique: true
  ...
  create_table 'sessions', force: :cascade do |t|
    ...
    t.index %w[token jti], name: 'index_sessions_on_token_and_jti', unique: true
    t.index ['token'], name: 'index_sessions_on_token', unique: true
    t.index %w[user_id token jti], name: 'index_sessions_on_user_id_and_token_and_jti', unique: true
  end
  ...
  create_table 'tournaments', force: :cascade do |t|
    ...
    t.index %w[name organization_id], name: 'index_tournaments_on_name_and_organization_id', unique: true
    t.index %w[organization_id name start_at], name: 'index_tournaments_on_org_id_name_start_date', unique: true
  ...
  create_table 'verification_tokens', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[identifier token], name: 'index_verification_token_on_identifier_and_token', unique: true
  end
