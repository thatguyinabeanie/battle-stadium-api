...
import { Card, Image, CardBody, Spacer, Link } from "@nextui-org/react";
  ...
  return (
    <Link key={organization.id} href={`/organizations/${organization.id}`}>
      <Card className="w-[420px] h-50 bg-transparent" {...cardProps}>
        <CardBody className="px-3 pb-1">
          <div className="relative overflow-hidden rounded-xl">
            ...
            <Image
              ...
              isZoomed
              alt="Card image"
              className="relative z-10 aspect-square w-20 h-20 hover:scale-110 object-cover object-top"
        ...
        {/* <CardFooter className="justify-end gap-2 w-full">
