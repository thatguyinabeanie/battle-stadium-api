...
CREATE UNIQUE INDEX IF NOT EXISTS "index_account_on_provider_and_providerAccountId" ON "account" USING btree ("provider","providerAccountId");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "index_account_on_userId" ON "account" USING btree ("userId");--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "index_session_on_sessionToken" ON "session" USING btree ("sessionToken");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "index_session_on_userId" ON "session" USING btree ("userId");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "index_verification_token_on_identifier_and_token" ON "verification_token" USING btree ("identifier","token");--> statement-breakpoint
