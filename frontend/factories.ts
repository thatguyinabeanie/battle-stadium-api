...
export const PhaseFactory = new Factory<Phase>()
  ...
  .attr('criteria', () => faker.datatype.boolean() ? faker.lorem.word() : null)
  .attr('started_at', () => faker.datatype.boolean() ? faker.lorem.word() : null)
  .attr('ended_at', () => faker.datatype.boolean() ? faker.lorem.word() : null)
...
export const PokemonFactory = new Factory<Pokemon>()
  ...
  .attr('held_item', () => faker.datatype.boolean() ? faker.lorem.word() : null)
...
export const TournamentFactory = new Factory<Tournament>()
  .sequence('id')
  .attr('name', () => faker.lorem.word())
  .attr('start_at', () => faker.datatype.boolean() ? faker.lorem.word() : null)
  .attr('organization', () => OrganizationFactory.build())
  .attr('format', () => FormatFactory.build())
  .attr('game', () => GameFactory.build())
  .attr('player_cap', () => faker.datatype.boolean() ? faker.number.int({min: 1, max: 100}) : null)
  .attr('player_count', () => faker.number.int({min: 1, max: 100}))
  .attr('end_at', () => faker.datatype.boolean() ? faker.lorem.word() : null)
  .attr('started_at', () => faker.datatype.boolean() ? faker.lorem.word() : null)
  .attr('ended_at', () => faker.datatype.boolean() ? faker.lorem.word() : null)
  .attr('registration_start_at', () => faker.datatype.boolean() ? faker.lorem.word() : null)
  .attr('registration_end_at', () => faker.datatype.boolean() ? faker.lorem.word() : null)
...
export const TournamentDetailsFactory = new Factory<TournamentDetails>()
  ...
  .attr('format', () => FormatFactory.build())
  .attr('game', () => GameFactory.build())
  .attr('check_in_start_at', () => faker.datatype.boolean() ? faker.lorem.word() : null)
